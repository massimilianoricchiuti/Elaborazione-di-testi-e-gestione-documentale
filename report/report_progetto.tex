...
Jinja2 genera il sito in \code{dist/}. La Home ha sei sezioni numerate, un indice persistente e collegamenti diretti: Introduzione, Consultazione, Documenti, Progetto e metodo, Documentazione e Compilazione. Le altre pagine sono \emph{Archivio}, \emph{Report dei dati} e \emph{Qualità dei dati}. L'Archivio offre ricerca, filtri e ordinamento; ogni CIG dispone di scheda completa, albero XML e sorgente integrale, oltre a documenti locali e fonti web con il nesso dichiarato. Gli HTML originari sono scaricati in ZIP; i PDF e gli XML sono disponibili direttamente. Il vecchio \code{progetto.html} rimanda alla Home. CSS, JavaScript, SVG e download sono locali; i dettagli includono microdata \code{schema.org/GovernmentService}. Senza JavaScript restano accessibili contenuti e collegamenti; ricerca, ordinamento e schede a linguetta richiedono JavaScript.
