...
Jinja2 genera il sito statico in \code{dist/}. La Home ha sei sezioni numerate e un indice persistente; \emph{Archivio}, \emph{Report dei dati} e \emph{Qualità dei dati} completano la navigazione. L'Archivio offre ricerca, filtri e ordinamento. Ogni CIG presenta Scheda completa, Struttura XML e Documenti; XML e DTD sono scaricabili e le fonti web dichiarano il nesso. I dettagli includono microdata \code{schema.org/GovernmentService}. Tutti gli asset sono locali. Senza JavaScript rimangono accessibili contenuti, collegamenti e concordanze; ricerca, ordinamento e linguette richiedono JavaScript.
