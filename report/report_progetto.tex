...
I test controllano parsing, DTD, modelli misti, fonti, estrazione, statistiche, viste XML, microdata, pagine e collegamenti interni. Il workflow esistente prepara il dataset, costruisce il sito, esegue i test e pubblica \code{dist/} a ogni push su \code{main} o \code{development}; copia il PDF versionato senza compilare LaTeX. Le verifiche coprono struttura e coerenza degli output, non certificano l'esattezza amministrativa delle fonti.
